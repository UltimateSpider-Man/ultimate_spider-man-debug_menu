...
struct game {
    ...
    void advance_state_running(Float a2)
    {
        ...
        void(__fastcall * func)(void*, void*, Float) = CAST(func, 0x00559FA0);
    ...
    void load_new_level_(const mString& a2, const vector3d& a3);
...
inline Var<game*> g_disable_p_menu_ptr { 0x0096B448 };
